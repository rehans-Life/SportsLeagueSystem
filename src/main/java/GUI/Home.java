...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel43.setText("Yearly Salary");

        jScrollPane8.setViewportView(jTextPane6);

        jLabel44.setText("Team ID");
                ...
                jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel37, javax.swing.GroupLayout.PREFERRED_SIZE, 83,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel6Layout.createSequentialGroup()
                                                .addGap(89, 89, 89)
                                                .addComponent(jLabel36, javax.swing.GroupLayout.PREFERRED_SIZE, 102,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 143,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel6Layout.createSequentialGroup()
                                                .addGap(70, 70, 70)
                                                .addComponent(jLabel35, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {
        // Example method for altering player data
        try {
            String playerId = jComboBox2.getSelectedItem().toString();
            String name = jTextPane3.getText().trim();
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jComboBox2ActionPerformed
        try {
            ...
            if (player != null) {
                jTextPane3.setText(player.getName());
                jTextPane1.setText(player.getAddress());
                jTextPane2.setText(player.getNationality());
                jTextPane4.setText(player.getDateOfBirth());
                jTextPane5.setText(player.getPosition());
                jTextPane6.setText(String.valueOf(player.getYearlySalary()));
                if (player.isCaptain()) {
    ...
    public void loadPlayerIDs() {
        try {
            for (Player player : sportsLeagueSystem.getPlayers()) {
                jComboBox2.addItem(String.valueOf(player.getId()));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error loading player IDs: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
